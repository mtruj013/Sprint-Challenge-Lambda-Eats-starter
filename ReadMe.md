...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    To gain access to the to the macth property without rendering a <Route> component

2. How would you explain form validation to someone who has never programmed before?

    It's the process for managing, distributing, completing, and processing forms.

3. In 1-2 sentences, define end to end testing. 

    testing what a user would be doing, like clicking a button or filling out a form  
